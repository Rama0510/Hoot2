...
public class AddBookActivity extends AppCompatActivity {
    EditText bookName,shortDesc,longDesc,etBookCount;
    String stBookName, stAuthorName, stShortDesc, stLongDesc,stBookCount;
    Button btnAddBook;
    ...
    void validateBookDetails(){
        ...
        if(flag){
            ...
            addBookDetails(stBookName,count,stShortDesc,stLongDesc);
        }else{
    ...
    void addBookDetails(String name,int count, String shortDesc, String longDesc){
        ...
        Book book = new Book(uKey,authId,name, shortDesc, longDesc, "5.0",count,0);
